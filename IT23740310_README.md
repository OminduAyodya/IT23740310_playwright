...
```powershell
python .\IT23740310_test_automation.py --excel "D:\test_automation-IT23740310\IT23740310\IT23740310 - Assignment 1 - Test cases.xlsx" --sheet " Test cases" --header-row 1 --input-col "Input" --expected-col "Expected output" --actual-col "Actual output" --status-col "Status" --url "https://www.pixelssuite.com/chat-translator" --wait-ms 10000 --retry-wait-ms 1500 --retries 10 --type-delay-ms 80 --slow-mo-ms 300 --save-every 1 --keep-open
```
